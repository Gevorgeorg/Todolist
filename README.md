...
![Экран регистрации](readme_imgs/auth.png)
...
![Экран управления досками и меню редактирования профиля](readme_imgs/board.png)

Экран категорий для целей, помимо функционала по управлению категориями присутствует фильтрация по взаимосвязанным
доскам.

![Экран управления категориями](readme_imgs/category.png)
...
![Экран управления целями](readme_imgs/goal.png)
